...
/// <summary>
/// Response model for CancelSaleResponse operation
/// </summary>
public class CancelSaleItemSaleResult : BaseResult
{
    /// <summary>
    ...
    /// </summary>
    public List<CancelSaleItemSaleItemResult> SaleItems { get; set; } = [];
}