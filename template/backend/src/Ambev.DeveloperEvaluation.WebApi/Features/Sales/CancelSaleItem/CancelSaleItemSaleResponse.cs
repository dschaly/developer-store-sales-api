...
/// <summary>
/// Response model for canceling a sale item
/// </summary>
public class CancelSaleItemSaleResponse : BaseResponse
{
    /// <summary>
    ...
    /// </summary>
    public List<CancelSaleItemSaleItemResponse> SaleItems { get; set; } = [];
}